...
<body>
  ...
  <!-- c:set permet d'ajouter la variable content du "layout.jsp" qui est le layout g�n�ral du projet-->
	<main class="main">
		 ...
		 <c:if test="${not empty utilisateur}">
			...
			<div class="filter-article">
				<div class="filter-article-item">
				  ...
				  <label for="vente2">Mes ench�res</label><br>  
				  <input type="checkbox" class="filter-article-choice" id="age3" name="age" value="100">
				  <label for="vente3">Mes ench�res report�es</label><br><br>
				</div>
				...
				<div class="filter-article-item">
				  ...
				  <label for="vente2">Mes ventes non d�but�s</label><br>  
				  <input type="checkbox"  name="vente" class="filter-article-choice" id="age3" name="age" value="100">
				  <label for="vente3">Ventes termin�es</label><br><br>
				</div>
			</div>
